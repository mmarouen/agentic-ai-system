from oai_user_config import DEFAULT_DATA_DIR, FORCE_DATESTAMP, \
                               DEFAULT_SHORTHAND, WAIT_BEFORE_LAUNCH
from oai_logx import colorize
from oai_mpi_tools import mpi_fork, msg
from oai_serialization_utils import convert_json
import base64
